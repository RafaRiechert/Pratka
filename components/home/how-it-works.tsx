    ...
    <section id="como-funciona" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-28">
      <AnimatedSection className="mx-auto max-w-2xl text-center">
        <h2 className="font-display text-4xl font-extrabold tracking-tight text-ink sm:text-5xl">
          Como <span className="text-gradient-pop">funciona</span>
        </h2>
      </AnimatedSection>
          ...
          <StaggerItem key={title}>
            <GlassCard interactive className="flex h-full flex-col gap-4 p-8">
              <div className="flex items-center gap-3">
                <div
                  className={`flex h-11 w-11 items-center justify-center rounded-xl border-2 border-ink text-ink ${tint}`}
                >
                  <Icon size={20} />
                </div>
                <span className="font-display text-2xl font-extrabold text-ink/25">
