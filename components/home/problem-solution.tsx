...
export default function ProblemSolution() {
  return (
    <section id="problema-solucao" className="scroll-mt-24">
      <div className="border-b border-line-dark bg-ink py-24">
        <div className="mx-auto max-w-3xl px-6">
          <AnimatedSection className="mb-10 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-md border border-line-dark text-paper/50">
              <CircleAlert size={20} />
            </div>
            <h2 className="font-display text-3xl font-bold tracking-tight text-paper/90 sm:text-4xl">
              O Problema
            </h2>
          </AnimatedSection>
          <AnimatedSection>
      ...
      <div className="bg-grid relative overflow-hidden py-24">
        <div className="relative z-10 mx-auto max-w-3xl px-6">
          <AnimatedSection className="mb-10 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-md border border-signal text-signal">
              <Sparkles size={20} />
            </div>
            <h2 className="font-display text-3xl font-bold tracking-tight text-ink sm:text-4xl">
              A <span className="text-signal">Solução</span>
            </h2>
          </AnimatedSection>
          <AnimatedSection>
